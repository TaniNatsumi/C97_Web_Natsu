...
export namespace LAppDefine
{
    ...
    export const ViewLogicalMaxLeft: number = -1.0;
    export const ViewLogicalMaxRight: number = 2.0;
    export const ViewLogicalMaxBottom: number = -211.0;
    export const ViewLogicalMaxTop: number = 235.0;

    // 相対パス
    export const ResourcesPath: string = "./Resources/";

    // モデルの後ろにある背景の画像ファイル
    export const BackImageName: string = "back_white.png";
